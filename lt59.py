...
import yunaff
import cmath
import iterModules59 as vph  # iterModules52 as vph
import lte2tpsa2map45 as lte2tpsa
from cytpsa import TPS
import veq59 as veq  # copied from veq52.py. veqnsls2sr_supercell_ch77_20150406_1_deltap0_lt11 as veq#veq20140204_bare_1supcell_deltapm02 as veq
...
for less_impotat_functions in [0]:
...
for all_ar2_functions in [0]:
    ...
    def find_first_converge(
        x=-2e-3, y=14e-3, ntheta_lim=10, init_tpsa_output=init_tpsa_output
    ):
    ...
    def ar2_xyntheta(
        ...
        ar, ntheta, idxmin = find_minimum_converge(x=x, y=y, ntheta_lim=10)
