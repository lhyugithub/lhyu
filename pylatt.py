...
# --- symplectic tracking based simulation
    ...
    def pltFma(self,xmin=0,xmax=0.5,ymin=0,ymax=0.5,order=5,figsize=(5,5)):
        '''
        plot FMA
        '''
        plt.figure(figsize=figsize)
        plt.scatter(self.dyap['fma'][:,0],self.dyap['fma'][:,1],s=2,
    ...
    def chromTrack(self,demin=-2.5e-2,demax=2.5e-2,nde=51,nturn=256,
                   amp=1e-4,polyorder=4,verbose=False,tunewindow=0):
        '''
        ...
        if verbose:
            ...
            plt.show()
        self.chxTrack,self.chyTrack = chx,chy
