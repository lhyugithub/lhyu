...
t0 = time.clock()
timing = [["in iterModule, start", time.clock()]]
...
import veq59 as veqm  # copied from veq52.py. veqnsls2sr_supercell_ch77_20150406_1_deltap0_lt11 as veq#veq20140204_bare_1supcell_deltapm02 as veq
import lineareq as leq
import mysum
...
print(time.clock() - t0, "in iterModules52, seconds for import sqdf and jfdf")
t0 = time.clock()
